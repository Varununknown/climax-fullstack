        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-start sm:items-end gap-3 sm:gap-6 pb-4 sm:pb-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3">
              <button onClick={handleWatch} className="bg-gradient-to-r from-red-600 via-red-500 to-pink-500 hover:from-red-500 hover:via-red-400 hover:to-pink-400 text-white rounded-full py-3 sm:py-4 px-6 sm:px-8 flex items-center gap-2 sm:gap-3 shadow-xl hover:shadow-2xl font-bold text-sm sm:text-lg transition-all border border-red-400/30 hover:border-red-300/50 hover:scale-[1.02]">
