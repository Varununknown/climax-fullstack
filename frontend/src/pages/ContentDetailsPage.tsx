            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-end gap-3 sm:gap-6 pb-4 sm:pb-6">
              ...
              <div className="flex-1 min-w-0 w-full">
                ...
                <div className="flex gap-2 mb-2">
                  ...
                  <button onClick={() => setShowClimaxModal(true)} className="flex-1 sm:flex-none bg-gradient-to-r from-gray-900/60 via-purple-700/60 to-gray-800/60 backdrop-blur-md hover:from-gray-800/70 hover:via-purple-600/70 hover:to-gray-700/70 text-white rounded-lg py-3 px-3 sm:px-4 flex items-center justify-center gap-1 shadow-lg hover:shadow-purple-500/50 font-semibold text-xs sm:text-sm transition-all transform hover:scale-105 border border-purple-500/40 hover:border-purple-400/60">
                    <span>⚡ Climax</span>
                  </button>
                </div>
